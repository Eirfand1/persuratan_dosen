...
class Nilai extends Database{
    ...
    public function all(){
        $data = $this->conn->query("SELECT nilai.*,m.nama_mhs,mtl.nama_matkul,s.nama_semester 
                FROM nilai
    ...
    public function create($nilai,$nilai_akhir,$mahasiswa_id,$matkul_id,$semester_id){
        return $this->conn->query("INSERT INTO $this->table (nilai,nilai_akhir,mahasiswa_id,semester_id) 
